...
![图 9-1. Git 对象模型的简化版](/figures/18333fig0901-tn.png)
...
![图 9-2. 当前 Git 数据的内容结构](/figures/18333fig0902-tn.png)
...
![图 9-3. Git 目录下的所有对象](/figures/18333fig0903-tn.png)
...
![图 9-4. 包含分支引用的 Git 目录对象](/figures/18333fig0904-tn.png)
